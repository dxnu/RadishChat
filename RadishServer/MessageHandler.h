...
namespace Chat {
	...
	{
		using delegate_type = Utils::Delegate<std::string, 
			std::function<void(ChatMessage)>>;
	public:
		void AddHandler(const std::string& msgType, std::function<void(ChatMessage msg)> callback)
		{
